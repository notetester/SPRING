...
<%@ include file = "../include/header.jsp" %>
   ...
   <div id="contents" class="">
      ...
      <div class="event-detail">
         <h2 class="tit">  카카오뱅크 카드로 결제하면 4,000원 즉시할인 </h2>
         <p class="event-detail-date">
            <span>기간</span> 
            <em>
              기간2020.08.01 ~ 2021.01.31
	          ...
	          <div class="event-html">
						<img  src="${pageContext.request.contextPath}/resources/img/카카오이벤트.png" width= "1100px" height= "3522px" alt="카카오 이벤트" onerror="errorImage(this)">
	       				</div>
