...
<%@ include file = "../include/header.jsp" %>
   ...
   <div id="contents" class="">
      ...
      <div class="event-detail">
         <h2 class="tit">   [프로모션] 해피펫(PET) 콤보 </h2>
         <p class="event-detail-date">
            <span>기간</span> 
            <em>
               	기간2020.07.31 ~ 2020.12.31
		       ...
		       <div class="event-html">
				<img  src="${pageContext.request.contextPath}/resources/img/스펀지팝.jpg" width= "1100px" height= "3522px" alt="스펀지 새창" onerror="errorImage(this)">
		       </div>
