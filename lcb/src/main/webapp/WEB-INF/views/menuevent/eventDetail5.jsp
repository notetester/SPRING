...
<link href="${pageContext.request.contextPath}/resources/css/style.css"
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/js/kakao.js" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources" rel="stylesheet">
...
<%@ include file = "../include/header.jsp" %>
   ...
   <div id="contents" class="">
      ...
      <div class="event-detail">
         <h2 class="tit"> 옴팡이 띄어앉기 동참 이벤트 </h2>
         <p class="event-detail-date">
            <span>기간</span> 
            <em>
          기간2020.07.20 ~ 2020.08.31
          ...
          <div class="event-html">
					<img  src="${pageContext.request.contextPath}/resources/img/해피머니.jpg" width= "1100px" height= "3522px" alt="움팡지게" onerror="errorImage(this)">
       				</div>
